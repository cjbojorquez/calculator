 ...
 * @author cjbojorquez
 */
public class Sustraction extends Operator {

    public Sustraction(String name, String value, int x, int y, int w, int h, JTextField textbox, Panel calculator) {
    ...
    public void setTypeOperator() {
        calculator.setBtnSelectedOperator(Sustraction.this);
    }
